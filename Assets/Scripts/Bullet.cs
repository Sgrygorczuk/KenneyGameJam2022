...
public class Bullet : MonoBehaviour
{
    ...
    private Transform _player; //Player Game Object 
    ...
    //If the enemy is shooting get player position and set up bullet rotation  
    private void EnemyBullet()
    {
        _player = GameObject.Find("Game").transform.Find("Player");
        RotationUpdate(_player.position);
    }
